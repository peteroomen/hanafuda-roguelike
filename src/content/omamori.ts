...
export const OMAMORI: readonly OmamoriDef[] = [
  ...
  o(
    ...
    'uncommon',
    'animals',
    'Boar, Deer, Butterflies gives ×2.5 Mult.',
  ...
  o(
    ...
    'uncommon',
    'chaff',
    'Kasu gives ×1.5 Mult, and +×0.25 for every Chaff beyond ten.',
    [
      {
        kind: 'yaku',
        filter: { ids: ['kasu'] },
        xmult: { base: 1.5, per: 'extraChaff', perUnit: 0.25 },
      },
    ],
    70,
    'broom',
  ...
  o(
    ...
    'uncommon',
    'greed',
    '+×0.5 Mult for each koi-koi you called this hand.',
    [{ kind: 'stop', xmult: { base: 1, per: 'koikoiCalls', perUnit: 0.5 } }],
    0,
    'carp',
  ),
  o(
    ...
    'common',
    'greed',
    '+6 Mult for each koi-koi you called this hand.',
    [{ kind: 'stop', mult: { per: 'koikoiCalls', perUnit: 6 } }],
    350,
    'dice',
  ),
  o(
    ...
    'common',
    'greed',
    'Earn 2 mon every time you call koi-koi.',
    [{ kind: 'economy', perKoikoi: 2 }],
    50,
    'cat',
  ),
  o(
  ...
  o(
    ...
    'common',
    'sake',
    'Moon Viewing and Flower Viewing each give +8 Mult.',
